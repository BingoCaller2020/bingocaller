...
=======
""" def updater():
        with urllib.request.urlopen("https://bingocallerapp.s3.eu-west-2.amazonaws.com/app-files/version.txt") as f:
>>>>>>> Stashed changes
        ...
        if retrievedVersion > version:
                ...
                print("You are running version " + version + " and the latest update is version " + retrievedVersion)
                sleep(2)
                input("Click Enter to update Bingo Caller")
                sleep(1)
